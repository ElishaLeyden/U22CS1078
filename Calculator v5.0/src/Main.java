    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            if(userInput.hasNextLong()){
                //getting user input and storing it in num1 variable
                num1 = userInput.nextLong();

                /*Using while loop so that if user input for second number is not a number
                code doesn't restart from  collecting input for num1
                */
                while(correctInput){
                    ...
                    //Condition to check if user actually entered a number
                    if(userInput.hasNextLong()){
                        //getting user input and storing it in num2 variable
                        num2 = userInput.nextLong();
